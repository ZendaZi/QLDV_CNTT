...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 01, 2022 lúc 04:57 PM
...
CREATE TABLE `contract` (
  ...
  `IDVersion` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `Expired_at` timestamp NULL DEFAULT NULL,
  `ContractPrice` bigint(20) NOT NULL,
  `ContractStatus` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(10, 2, 1, 1, '1.1.0', '2022-11-19 20:43:19', '2023-11-19 20:43:19', 3240000, 'Pending'),
(11, 6, 1, 4, '4.1.0', '2022-12-01 08:58:04', '2023-12-01 08:58:04', 2880000, 'Pending');
...
CREATE TABLE `contract_image` (
  `IDContractImage` int(11) NOT NULL,
...
INSERT INTO `contract_image` (`IDContractImage`, `IDContract`, `Link`, `ContractImgageDetails`, `Created_at`) VALUES
(1, 1, 'https://i0.wp.com/eforms.com/download/2018/05/Employment-Contract-Agreement.png?ssl=1', 'Hợp đồng số 1', '2022-10-13 07:27:30'),
(2, 2, 'https://i1.wp.com/eforms.com/images/2019/08/Service-Contract-Template.png?fit=1600%2C2070&ssl=1', 'Hợp đồng số 2', '2022-10-13 09:05:30'),
(3, 3, 'https://signaturely.com/wp-content/uploads/2020/06/construction_contract_agreement_template1.jpg', 'Hợp đồng số 3', '2022-10-16 20:07:30'),
(4, 4, 'https://signaturely.com/wp-content/uploads/2020/06/construction_contract_agreement_template1.jpg', 'Hợp đồng số 4', '2022-09-15 10:00:00'),
(5, 5, 'https://i0.wp.com/eforms.com/download/2018/05/Employment-Contract-Agreement.png?ssl=1', NULL, '2022-10-24 07:41:39'),
(6, 6, 'https://i0.wp.com/eforms.com/download/2018/05/Employment-Contract-Agreement.png?ssl=1', NULL, '2022-10-24 07:46:57'),
(7, 7, 'https://i0.wp.com/eforms.com/download/2018/05/Employment-Contract-Agreement.png?ssl=1', NULL, '2022-10-24 08:28:09'),
(8, 8, 'https://i0.wp.com/eforms.com/download/2018/05/Employment-Contract-Agreement.png?ssl=1', NULL, '2022-11-02 07:17:50'),
(9, 9, '/public/storage/contract-image/lovepik-data-analysis-data-management-icon-free-vector-png-image_401355039_wh860.png', NULL, '2022-11-02 08:42:00'),
(10, 10, 'https://signaturely.com/wp-content/uploads/2020/06/construction_contract_agreement_template1.jpg', NULL, '2022-11-19 20:43:19'),
(11, 11, 'image/contract\\sample_contract1.png', NULL, '2022-12-01 08:58:04');
...
('2', 'Vũ Ngọc Nhật Vy', '2000-08-09', 'Vị Thanh, Hậu Giang', '364012789', '03343435881', 'user@gmail.com', 'Sales', 'image\\3x4VNNV2.jpg'),
...
('4', 'Nguyễn Nhật Khang', '2000-01-01', 'Vị Thanh- Hậu Giang', '123456789', '0334358880', 'nhanvienA@gmail.com', 'Sales', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNMigcti3QIcvX5jSF29YXu_pY5kRjy1ace-hnOe_aek4u68vMWRxcW6f4iUqchttYbpQ&usqp=CAU'),
('5', 'Nguyễn Thiên Đăng', '2000-02-01', 'Vị Thanh- Hậu Giang', '123456780', '0334358889', 'tdang@gmail.com', 'Sales', 'image\\3x4_NV_Nam.jpg'),
('6', 'Phan Đăng Minh', '2000-06-01', 'Vị Thanh- Hậu Giang', '012345678', '1234567892', 'pdm@gmail.com', 'Sales', 'image\\3x4_NVNam2.jpg'),
('7', 'Lê Tấn Trung', '1999-06-06', 'Vị Thanh- Hậu Giang', '013456789', '012345678', 'ltt@gmail.com', 'Sales', 'image\\pexels-skinny-alien-2318554.jpg');
...
(1, 'Máy chủ ảo - Smart Cloud', 'SmartCloud là dịch vụ cho phép khách hàng chủ động khởi tạo các máy ảo với tài nguyên CPU, RAM và lưu trữ tùy ý...', 1),
(2, 'Tên miền Việt Nam', 'Tên miền (Domain name) là định danh của website trên Internet. Tên miền thường gắn với tên công ty và thương hiệu của doanh nghiệp. Tên miền là duy nhất và được ưu tiên cấp phát cho chủ thể nào đăng ký trước.', 1),
(3, 'Cổng thông tin điện tử vnPortal', 'vnPortal cung cấp những tiện ích ứng dụng công nghệ thông tin, tạo ra môi trường làm việc hiện đại, nhanh chóng, hiệu quả, tiết kiệm thời gian và kinh phí cho người dùng.', 2),
...
(4, '3.1.0', 1, '1', 'Hữu ích!!!', 5, '2022-12-01'),
(5, '4.1.0', 6, '1', 'Dùng rất tốt, phần mềm rất đáng để sử dụng lâu dài!', 5, '2022-12-01');
...
CREATE TABLE `product_image` (
  `IDProductImage` int(12) NOT NULL,
  `IDProduct` int(10) UNSIGNED NOT NULL,
  `Link` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `product_image` (`IDProductImage`, `IDProduct`, `Link`, `ImageDetails`) VALUES
(1, 1, 'https://onesme.vn/resources/upload/file/services/images/03082021/2021080320482a24fc28-daa6-4eba-b8be-b4ae91ba6156.PNG', 'Máy chủ ảo - Smart Cloud'),
(2, 2, 'https://onesme.vn/resources/upload/file/services/images/03082021/2021080321461156dc44-9b3d-407c-9558-3dd2ab56004d.PNG', 'Tên miền Việt Nam'),
(3, 3, 'https://onesme.vn/resources/upload/file/services/images/17082022/202208171520bf11d9f4-24ae-43ff-8456-e7a763183253.JPG', 'Cổng thông tin điện tử vnPortal'),
(4, 4, 'image/product\\product1.webp', 'Hình ảnh dịch vụ số 4'),
(5, 1, 'https://onesme.vn/resources/upload/file/services/images/04112022/202211041658443d1f7c-779b-4acd-b306-c3a7ec4b8e00.WEBP', 'Máy chủ ảo - Smart Cloud');
...
INSERT INTO `product_promotion` (`IDProductPromotion`, `IDVersion`, `ProductPromotionDetails`, `ProductDiscount`, `Created_at`, `Expired_at`, `PromotionStatus`) VALUES
(1, '1.1.0', 'Khuyến mãi tri ân khách hàng', 0.2, '2022-11-14', '2022-11-24', 1);
...
CREATE TABLE `promotion` (
  `IDPromotion` int(12) NOT NULL,
  `Promotion` varchar(32) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `PromotionName` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `PromotionDetails` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `RemainingUsage` int(11) NOT NULL,
  `Created_at` date NOT NULL,
  `Expired_at` date NOT NULL,
  `ForCategoryID` varchar(255) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `ForProductID` varchar(255) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `ForVersionID` varchar(24) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
...
INSERT INTO `promotion` (`IDPromotion`, `Promotion`, `PromotionName`, `PromotionDetails`, `RemainingUsage`, `Created_at`, `Expired_at`, `ForCategoryID`, `ForProductID`, `ForVersionID`, `Discount`) VALUES
(1, 'KMT11', 'Khuyen mai thang 11', 'Giảm 20%', 2, '2022-11-14', '2022-11-24', 'Hạ Tầng', NULL, NULL, 0.10),
(2, 'Test', 'Test', 'Test', 2, '2022-11-14', '2022-11-15', NULL, NULL, '1.1.0', 0.20),
(3, 'TRIANT12', 'Tri ân khách hàng tháng 12', 'Tri ân khách hàng tháng 12', 2, '2022-12-01', '2022-12-31', 'Quản trị Doanh nghiệp', NULL, NULL, 0.20);
...
('jCARvSXTkW1e6NIv6lfS98Rka0Yk7h6pgUlSB8zL', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36', '', 1669913435);
...
(1, 'Nguyễn Danh Hưng', 'hung2000hg@gmail.com', NULL, 1, '$2y$10$jPaU9Bhq3Ooy2yLKIjeKR.Zey2MZtxBotl2MYCWR5oLmBLB9EPUdu', NULL, NULL, NULL, 'FZmky8iXB7HISkskTWNFNONfYuHp9rtavKmAO3LNWf43g3iv1R8Tip5ikGUj', 3, NULL, '2022-09-26 21:29:43', '2022-10-28 20:36:25'),
(2, 'Vũ Ngọc Nhật Vy', 'user@gmail.com', NULL, 0, '$2y$10$gfCb39s8pr1J.iB5VvvpNuNYJhi4ua89dhlcmsiYwis3l82Vtxo0i', NULL, NULL, NULL, NULL, 2, NULL, '2022-10-28 20:34:18', '2022-10-28 20:49:45'),
(3, 'Trần Quốc Khôi', 'test@gmail.com', NULL, -1, '$2y$10$K7fgQ4ukzRb65O//qrTW7eagjYVumAyNsvL.//XGLSPkk2.r89Guq', NULL, NULL, NULL, NULL, NULL, NULL, '2022-11-08 20:14:55', NULL),
(4, 'Nguyễn Nhật Khang', 'nhanvienA@gmail.com', NULL, 0, '$2y$10$eXNng9JUVy412bMYdSoViuLyHUW4LP9afz1Mua0ey5srlLPSglDGC', NULL, NULL, NULL, NULL, NULL, NULL, '2022-12-01 07:15:04', NULL),
(5, 'Nguyễn Thiên Đăng', 'tdang@gmail.com', NULL, 0, '$2y$10$4FCKu9/pA32PSZgjcObxW..r0t1wJsPS3wXYa1ChZORD2DumuRG86', NULL, NULL, NULL, NULL, NULL, NULL, '2022-12-01 07:16:05', NULL),
(6, 'Phan Đăng Minh', 'pdm@gmail.com', NULL, 0, '$2y$10$TeqLBMhyTRjOim87LjZtsusWD1eAkRmAR8vs0bFzg5MtlCPZADUOm', NULL, NULL, NULL, NULL, NULL, NULL, '2022-12-01 07:30:41', NULL),
(7, 'Lê Tấn Trung', 'ltt@gmail.com', NULL, 0, '$2y$10$UZC5vpcoKwJPI3v4tGTOAe.Q02NgNo3Q/ZhuulSx52pm6bSLJ0wES', NULL, NULL, NULL, NULL, NULL, NULL, '2022-12-01 07:34:12', NULL);
...
ALTER TABLE `contract_image`
  ADD PRIMARY KEY (`IDContractImage`),
...
ALTER TABLE `product_promotion`
  ADD PRIMARY KEY (`IDProductPromotion`),
  ADD KEY `product_promotion_idproduct_foreign` (`IDVersion`);
...
--
ALTER TABLE `contract`
  MODIFY `IDContract` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `contract_image`
--
ALTER TABLE `contract_image`
  MODIFY `IDContractImage` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `product_feedback`
  MODIFY `IDFeedback` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `product_image`
--
ALTER TABLE `product_image`
  MODIFY `IDProductImage` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `product_promotion`
--
ALTER TABLE `product_promotion`
  MODIFY `IDProductPromotion` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `promotion`
--
ALTER TABLE `promotion`
  MODIFY `IDPromotion` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
