...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 29, 2022 lúc 03:55 AM
...
INSERT INTO `category` (`IDCategory`, `CategoryName`, `CategoryDetails`, `CategoryImage`) VALUES
(1, 'Hạ Tầng', 'Các dịch vụ về hạ tầng', 'https://onesme.vn/resources/upload/file/services/images/17082022/202208171407972e6b6e-2769-4ec9-8d8c-356d6e8c15dd.JPG'),
(2, 'Quản trị Doanh nghiệp', 'Các dịch vụ về quản trị Doanh nghiệp', 'https://onesme.vn/resources/upload/file/services/images/17082022/202208171407972e6b6e-2769-4ec9-8d8c-356d6e8c15dd.JPG');
...
(5, 2, 1, 1, '1.2.0', '2022-10-24 07:41:39', '2023-10-24 07:41:39', 9600000, 'Pending'),
(6, 3, 1, 1, '1.1.0', '2022-10-24 07:46:57', '2023-10-24 07:46:57', 6000000, 'Pending'),
(7, 3, 1, 3, '3.1.0', '2022-10-24 08:28:09', '2023-10-24 08:28:09', 3000000, 'Pending');
...
(5, NULL, NULL, '2022-10-24 07:41:39'),
(6, NULL, NULL, '2022-10-24 07:46:57'),
(7, NULL, NULL, '2022-10-24 08:28:09');
...
(6, 'Công ty phần mềm BE', 'Vị Thanh- Hậu Giang', '0334358889', 'BE@solution.vn', 'Potential');
...
INSERT INTO `information_user` (`ID`, `Fullname`, `Birthday`, `Address`, `IDCardNumber`, `PhoneNumber`, `Email`, `Competence`, `Link`, `token`) VALUES
('1', 'Nguyễn Danh Hưng', '2000-06-06', 'Vị Thanh, Hậu Giang', '364012666', '0333358883', 'hung2000hg@gmail.com', 'Sales', 'Enterprise', 'Null');
...
(1, '1.1.0', 1, '1', 'Dịch vụ tốt, chăm sóc khách hàng tận tâm, hài lòng', 5, '2022-10-27'),
(2, '1.1.0', 2, '1', 'Chất lượng dịch vụ tạm ổn', 3, '2022-10-26'),
(3, '1.2.0', 1, '1', 'Tạm được', 4, '2022-10-26'),
(4, '3.1.0', 3, '1', 'Dịch vụ tốt nhất hệ mặt trời', 5, '2022-10-27');
...
INSERT INTO `product_version` (`IDProduct`, `IDVersion`, `VersionDetails`) VALUES
(1, '1.1.0', 'Phiên bản giới hạn bộ nhớ ram 8GB, sử dụng HDD'),
(1, '1.2.0', 'Phiên bản giới hạn bộ nhớ ram 16GB, sử dụng SSD'),
(2, '2.1.0', 'Tên miền .NET.VN'),
(3, '3.1.0', 'Cơ bản'),
(3, '3.2.0', 'Nâng cao');
...
('JCArGYVeocowF3GItirsc2wAvYOqy8UlhJHXE7c0', 2, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36', '', 1667014488),
('yMVS02tcLQqWdW0pwlZkHMCPGFrKIblX5uPIICtL', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36', '', 1667015435);
...
(1, 'Nguyen Danh Hung', 'hung2000hg@gmail.com', NULL, '$2y$10$jPaU9Bhq3Ooy2yLKIjeKR.Zey2MZtxBotl2MYCWR5oLmBLB9EPUdu', NULL, NULL, NULL, 'iYMQcNGwRxk5PJikMEVuL3MSoMKZMnJFJ8PfryJZgS4wlDD50pRv80IqvuKO', 3, NULL, '2022-09-26 21:29:43', '2022-10-28 20:36:25'),
(2, 'BestSale', 'user@gmail.com', NULL, '$2y$10$gfCb39s8pr1J.iB5VvvpNuNYJhi4ua89dhlcmsiYwis3l82Vtxo0i', NULL, NULL, NULL, NULL, 2, NULL, '2022-10-28 20:34:18', '2022-10-28 20:49:45');
...
--
ALTER TABLE `contract`
  MODIFY `IDContract` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `product_feedback`
  MODIFY `IDFeedback` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
